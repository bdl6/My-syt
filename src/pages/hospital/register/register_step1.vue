    ...
    <div class="bottom">
      ...
      <div class="doctor">
        ...
        <div class="moring">
          ...
          <!--每一个医生的信息-->
          <div class="doc_info" v-for="(item, index) in 3" :key="index">
            <!-- 展示医生的名字|技能 -->
            <div class="left">
              <div class="info">
                <span>骨科</span>
              ...
              <div class="skill">针灸</div>
            </div>
            <!-- 右侧区域展示挂号的钱数-->
            <div class="right">
              <div class="money">￥111</div>
              <el-button type="primary" size="default" @click="goStep2">付款</el-button>
            </div>
          </div>
        </div>
      </div>
...
import type { Doctor, DocArr, HospitalWordData, DoctorResponseData } from '@/api/hospital/type'
//获取路由对象
